...
- Seedance 2.5 maps public `480p` and `720p` rows with and without reference-video input. Automatic duration `-1` is estimated at the 30-second maximum so preflight does not understate potential cost.
